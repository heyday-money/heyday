...
if private and not public:
    raise SystemExit('::error::HEYDAY_UPDATER_PUBLIC_KEY is missing or empty. Add the matching .pub file contents under repository Settings > Secrets and variables > Actions > Variables as a repository variable. Environment-scoped settings are not used by this workflow.')
