...
const categoryHelp: Record<PlannerCategoryId, string> = {
  ...
  cards: 'Recorded cash/bank repayments and transfers are totaled by card and payday cycle. These are full bill payments, with no installment split. In cycles with payments, the recorded total replaces linked installment forecasts. No purchases or unpaid debt are deducted here. Manual extra rows add to the recorded total.',
  expenses: 'Cash, bank transfer and debit payments by transaction category. Credit card purchases count when the bill is paid, not again here.',
}
const summaryHelp = {
  opening: 'Initial cash and bank balance, then the previous cycle’s closing cash. Missing opening cash is unavailable; zero is valid.',
